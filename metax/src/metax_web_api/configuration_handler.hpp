...
private:
        ...
        static const std::string URI_CONFIG_START_CHANNEL_PAIRING;
        ...
        static const std::string URI_CONFIG_CONNECT_SERVER_PUBLIC;
        static const std::string URI_CONFIG_OPEN_CHANNEL;
...
private:
        ...
        void handle_start_pairing(Poco::Net::HTTPServerRequest& req,
                std::promise<web_api_adapter::ims_response>& pr);
        void handle_start_channel_pairing(Poco::Net::HTTPServerRequest& req,
                std::promise<web_api_adapter::ims_response>& pr);
        void handle_request_keys(Poco::Net::HTTPServerRequest& req,
                std::promise<web_api_adapter::ims_response>& pr);
        void handle_request_public_key(Poco::Net::HTTPServerRequest& req,
                std::promise<web_api_adapter::ims_response>& pr);
        void handle_regenerate_user_keys(Poco::Net::HTTPServerRequest& req,
                std::promise<web_api_adapter::ims_response>& pr);
        void handle_open_channel(Poco::Net::HTTPServerRequest& req,
                std::promise<web_api_adapter::ims_response>& pr);
