...
public:
        ...
        /**
         * @brief - sends generate_own_channel request to Metax.
         */
        void generate_pair_channel(const std::string& public_key);
        
        /**
         * @brief - sends open_channel request to Metax.
         */
        void handle_open_channel_request(std::promise<web_api_adapter::ims_response>*,
                                     const std::string& c,
                                     const std::string& ip);
        ...
        /**
         * @brief Send start channel pairing request to metax.
         *
         * Metax will pass to pairing mode.
         */
        void handle_start_channel_pairing(
                std::promise<web_api_adapter::ims_response>* pr,
        ...
        /**
         * @brief Send request_public_key request to metax.
         */
...
private:
        ...
        void handle_open_channel_response();
        void handle_accept_share_fail();
        void handle_share_accepted();
        void handle_request_pair_channel_accept();
        void handle_request_pair_channel_response();
        ...
        void handle_get_channel_generated_code();
        void handle_start_pairing_fail();
        void handle_start_channel_pairing_fail();
        void handle_request_keys_response();
        void handle_request_public_key_response(const metax::ims_kernel_package& resp);
