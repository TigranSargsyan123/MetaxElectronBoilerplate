...
namespace leviathan {
        namespace metax {
                ...
                enum command
                {
                        ...
                        decrypt_key,
                        pair_channel_accept_share,
                        request_pair_channel_response,
                        accept_channel_share, share_channel_accepted,
                        save_stream_fail,
                        get_livestream_fail,
                        ...
                        get_channel_generated_code,
                        open_channel, request_pair_channel_accept,
                        cancel_pairing, start_channel_pairing,
                        get_pairing_peers, get_pairing_peers_response,
                        request_keys, request_keys_response,
                        request_public_key_response,
                        ...
                        start_channel_pairing_fail,
                        add_peer_failed, request_public_key_fail,
                        request_public_key,
                        ...
                        //TODO, change location of command to Storage <-> Kernel
                        router_update_confirm,
        ...
        : leviathan::platform::default_package
{
        ...
        kernel_cfg_package& operator= (const kernel_cfg_package& p)
        {
        ...
        : leviathan::platform::default_package
{
        ...
        link_cfg_package& operator= (const link_cfg_package& p)
        {
                request_id = p.request_id;
                cmd = p.cmd;
                default_package::operator=(p);
        ...
        link_cfg_package& operator= (const default_package& p)
        {
                this->default_package::operator= (p);
                return *this;
        }
        ...
        : leviathan::platform::default_package
{
        ...
        void serialize(default_package& pkg)
        {
                ...
                uint32_t rqt = (uint32_t)request_type.size();
                uint32_t n_rqt = Poco::ByteOrder::toNetwork(rqt);
                std::memcpy(p + offset, (char*)&n_rqt, sizeof(n_rqt));
                offset += sizeof(n_rqt);
                std::memcpy(p + offset, request_type.c_str(), rqt);
                offset += rqt;
        ...
        uint32_t extract_header(const default_package& pkg)
        {
                ...
                uint32_t n_rqt;
                std::memcpy((char*)&n_rqt, src + offset, sizeof(uint32_t));
                uint32_t rqt = Poco::ByteOrder::fromNetwork(n_rqt);
                offset += sizeof(uint32_t);
                request_type.assign(src + offset, rqt);
                offset += rqt;
