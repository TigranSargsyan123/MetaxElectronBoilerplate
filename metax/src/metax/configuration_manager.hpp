...
private:
        ...
        void handle_kernel_pair_channel_accept_share();
        ...
        void handle_kernel_start_channel_pairing();
        void handle_kernel_cancel_pairing();
        void handle_kernel_request_keys();
        void handle_kernel_request_public_key();
        void handle_kernel_open_channel();
        ...
        void get_caching_router(const Poco::Util::XMLConfiguration* c);
        ...
        void handle_link_get_channel_generated_code();
        void handle_link_start_pairing_fail();
        void handle_link_start_channel_pairing_fail();
        void handle_link_pair_channel_accept();
        void handle_link_pair_channel_response();
