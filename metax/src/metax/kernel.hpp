...
private:
        ...
        void handle_storage_router_update_confirm();
        ...
        void process_ims_accept_channel_share_request();
        ...
        void handle_config_request_pair_channel_accept();
        void handle_config_request_pair_channel_response();
        void handle_ims_pair_channel_accept_share();
        void handle_config_get_generated_code();
        void handle_config_get_channel_generated_code();
        void handle_config_start_channel_pairing_fail();
        void handle_key_manager_request_public_key_response(
                        const kernel_key_manager_package&);
        void handle_key_manager_request_keys_response(
                        const kernel_key_manager_package&);
        void handle_request_public_key_fail(ID32 request_id,
